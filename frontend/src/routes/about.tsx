          ...
          <SectionForDoc id={HEADERS.studyBackgrounds.id}>
            ...
            <TypographyContent>
              <TypographyP>
                ...
                therefore play a key role in achieving the targets of a
              ...
              <TypographyP>
                ...
                choices. This is especially the case when considering the larger
                scale, at the level of national and EU building stocks.
              </TypographyP>
              <TypographyP>
                To address this, the European Commission has initiated a
                preparatory action aimed at developing a better understanding of
                WLC emissions and carbon removals of buildings and construction
                in the EU. This analysis will help establish a more accurate
                picture of the climate impact of Europe’s building stock and the
            ...
            <TypographyContent id={HEADERS.disclaimer.id}>
              ...
              <TypographyContent>
                ...
                <TypographyP>
                  ...
                  user-friendly tool intended to illustrate the potential
