...
const envProvider = import.meta.env
  ...
  : {
      ...
      VITE_DATA_PATH: process.env.VITE_DATA_PATH ?? "",
      CI: "true",
      MODE: process.env.MODE ?? "",
      VITE_DEBUG: process.env.VITE_DEBUG ?? undefined,
    };
...
export const env = createEnv({
   ...
   */
  runtimeEnv: {
    PUBLIC_API_URL: (envProvider.VITE_API_URL as string | undefined) ?? "/api",
    PUBLIC_NODE_ENV:
